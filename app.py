...
sales_data = pd.read_excel("C:/Users/izabe/Python-shiny/Adidas_US_Sales_Datasets.xlsx")
...
def server(input, output, session):
    ...
    def piechart():
        if not grouped_data().empty:
            sales_by_region_perc = grouped_data()/grouped_data().sum()
